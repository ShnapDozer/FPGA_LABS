...
HD_PWD='C:/Users/8201525/Desktop/labs/labs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_riscv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_riscv.tcl
